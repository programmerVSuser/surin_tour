        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: () {
                showAlert2('ออกจากระบบ',
                    'คุณต้องการออกจากระบบใช่หรือไม');
              },
            ),
            // IconButton(
            //   onPressed: () {
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: Expanded(
                  child: AutoSizeText(
                    'ยินดีต้อนรับสู่เเอปปลิเคชันขนส่ง สุรินทร์ - กรุงเทพ',
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                            ...
                            child: ElevatedButton(
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 5,),
                                  Container(child: Text("ติดต่อผู้ดูเเล")),
                                ],
                              ),
                              onPressed: () {
                            ...
                            child: ElevatedButton(
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 5,),
                                  Container(child: Text("ตำเเหน่ง บขส")),
                                ],
                              ),
                              onPressed: () {
                                Navigator.push(context,
                            ...
                            child: ElevatedButton(
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 5,),
                                  Container(child: AutoSizeText("ข้อตกลง")),
                                ],
                              ),
                              onPressed: () {
                                //Conditions
                            ...
                            child: ElevatedButton(
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 5,),
                                  Container(child: Text("ประวัติการจ่ายเงิน")),
                                ],
                              ),
                              onPressed: () {
